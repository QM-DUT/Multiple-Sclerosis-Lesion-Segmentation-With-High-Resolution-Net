...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg,channel, **kwargs):
        self.inplanes = 16
        extra = cfg['MODEL']['EXTRA']
        super(PoseHighResolutionNet, self).__init__()

        # stem net
        self.conv1 = nn.Conv3d(channel, 16, kernel_size=3, stride=1, padding=1,
                               bias=False)
...
class PoseHighResolutionNet(nn.Module):
    ...
    def init_weights(self, pretrained=''):
        ...
        #     raise ValueError('{} is not exist!'.format(pretrained))
'''
def get_pose_net(cfg, is_train,channel, **kwargs):
    model = PoseHighResolutionNet(cfg,channel, **kwargs)
