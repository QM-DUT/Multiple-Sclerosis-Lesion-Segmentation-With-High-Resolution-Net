...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default="./results_HRNet_ISBI_4", help="save directory")
    ...
    # for k in [3,4,0]:
        ...
        train_img_masks, val_img_masks, real_train_mask_list, real_test_mask_list=load_data_aug_4(opt.root,k)
