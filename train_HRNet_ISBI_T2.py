...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='HRNet T2')
    ...
    parser.add_argument('--save_dir', type=str, default="./results_HRNet_ISBI_T2", help="save directory")
